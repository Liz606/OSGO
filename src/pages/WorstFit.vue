        ...
        <div class="row">
          <div class="col-xs-12 col-md-4">
            <div class="illustrate-container">
              <div class="title">动态存储分配算法—最差适应（worst-fit）</div>
              <blockquote>
               最差适应：分配最大的空闲区域。同样，必须查找整个列表，除非列表按大小排序。这种方法可以产生最大剩余空闲区域，该空闲区域可能比最佳适应方法产生的较小剩余空闲区域更为有用。但在速度和存储的利用上，首次适应和最佳适应要比最差适应好。
               </blockquote>
